  ...
  return (
    <>
      {news.map((newsfeed, index) => {
        ...
        return (
          <div key={index} className="main-container rounded-lg mt-4 bg-amber-200 shadow">
            <div className="newsCard">
              <div className="card-header p-4">
                <div className="uppersection flex justify-between gap-2">
                  <div className="flex">
                    <img src={newsfeed.profileImg} alt="user" className="h-11 w-11 rounded-full" />
                    <div className="ml-3">
...
{/* /// using logical AND */}
              {newsfeed.uploadedImg && (
                <div className="image-section">
                  <img src={newsfeed.uploadedImg} alt="uploaded" />
                </div>
              )}
